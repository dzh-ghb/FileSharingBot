...
public interface MainService { //для обработки всех входящих сообщений и последующего вызова необходимого сервиса в зависимости от типа входящего сообщения
