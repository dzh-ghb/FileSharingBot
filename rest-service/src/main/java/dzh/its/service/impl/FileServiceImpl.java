...
public class FileServiceImpl implements FileService {
    ...
    @Override
    public AppDocument getDocument(String docId) { //получения объекта документа из БД по идентификатору
    ...
    @Override
    public AppPhoto getPhoto(String photoId) { //получения объекта фото из БД по идентификатору
        //TODO: добавить дешифрование хеш-строки
